...
const TrustedBy = () =>{
    return (
         //sekcja z logotypami firm, wycentrowana
        <div className='flex flex-col items-center px-4 sm:px-12 lg:px-24 xl:px-40 gap-10 text-gray-700 dark:text-white/80'>
            
            <h3 className = 'font-semibold'>Trusted by Innovative Companies</h3>

            {/* rząd logotypów, zawija się na kolejne linie jeśli nie mieści się w jednej */}
