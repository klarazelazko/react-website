  ...
  return (
    <div className='flex justify-between items-center px-4 sm:px-12 lg:px-24 xl:px-40 py-4 sticky top-0 z-20 backdrop-blur-xl font-medium bg-white/50 dark:bg-gray-900/70'>
      ...
      <div className={`text-gray-700 dark:text-white sm:text-sm ${
        ...
        <img src={assets.close_icon} alt="" onClick={() => setSidebarOpen(false)}
      ...
      <a href="#contact-us"
        className='text-sm max-sm:hidden flex items-center gap-2 bg-primary text-white px-6 py-2 rounded-lg cursor-pointer hover:scale-105 transition-all'>
        Let's talk! <img src={assets.arrow_icon} width={14} alt="" />
      </a>
      </div>
    </div>
  );
